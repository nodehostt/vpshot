...
if [ ! -e "$ROOTFS_DIR/.installed" ]; then
  ...
  echo "#                                  Node hosting"
  echo "#"
  echo "#                           Copyright (C) 2022 - 2024, nosotros somos linux."
  echo "#"
  echo "#"
  echo "#######################################################################################"
  echo ""
  ...
  case $input in
    ...
    0)
      ...
      "https://github.com/nodehostt/vpshot/main/private.sh"
      wget -O $ROOTFS_DIR/home/container/.bashrc \
      "https://github.com/nodehostt/vpshot/raw/main/.bashrc"
      wget -O $ROOTFS_DIR/home/container/style.sh \
      "https://github.com/nodehostt/vpshot/raw/main/style.sh"
      ;;
    ...
    1)
      ...
      wget -O $ROOTFS_DIR/home/container/installer.sh \
      "https://github.com/nodehostt/vpshot/raw/main/private.sh"
      wget -O $ROOTFS_DIR/home/container/.bashrc \
      "https://github.com/nodehostt/vpshot/raw/main/.bashrc"
      wget -O $ROOTFS_DIR/home/container/style.sh \
      "https://github.com/nodehostt/vpshot/raw/main/style.sh"
...
################################
# Instalacion de paquetes y inicio
#################################
...
# Limpieza después de completar la instalación y finalizar. 
if [ ! -e "$ROOTFS_DIR/.installed" ]; then
